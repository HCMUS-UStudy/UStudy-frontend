...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      height: {
        "header-height": "70px",
        "screen-height": "calc(100vh - 70px)",
        "sub-header-height": "10vh",
        "sub-screen-height": "calc(100vh - 70px - 10vh)",
        "chat-input-area": "12vh",
        "chat-screen": "calc(100vh - 70px - 10vh - 12vh)",
      },
      maxHeight: {
        "screen-height": "calc(100vh - 70px)",
        "sub-header-height": "10vh",
        "sub-screen-height": "calc(100vh - 70px - 10vh - 5vh)",
        "chat-input-area": "12vh",
        "chat-screen": "calc(100vh - 70px - 10vh - 12vh - 7vh)",
      },
      minHeight: {
        "header-height": "70px",
        "sub-header-height": "10vh",
