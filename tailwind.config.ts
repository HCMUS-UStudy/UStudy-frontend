...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      height: {
        "header-height": "55px",
        "screen-height": "calc(100vh - 55px)",
        "sub-header-height": "10vh",
        "sub-screen-height": "calc(100vh - 55px - 10vh)",
        "chat-input-area": "12vh",
        "chat-screen": "calc(100vh - 55px - 10vh - 12vh)",
      },
      maxHeight: {
        "screen-height": "calc(100vh - 55px)",
        "sub-header-height": "10vh",
        "sub-screen-height": "calc(100vh - 55px - 10vh - 5vh)",
        "chat-input-area": "12vh",
        "chat-screen": "calc(100vh - 55px - 10vh - 12vh - 7vh)",
      },
      minHeight: {
        "header-height": "55px",
        "sub-header-height": "10vh",
