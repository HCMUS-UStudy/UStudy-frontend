...
import { FaUserGraduate, FaChalkboardTeacher, FaBuilding, FaSearch, FaEdit, FaTrashAlt } from 'react-icons/fa';
...
const AccountPage: React.FC = () => {
  ...
  return (
    <>
      <h2 className="text-3xl font-bold tracking-tight my-4">Quản lý tài khoản người dùng</h2>
      <h2 className="text-xl tracking-tight mb-6">Tìm tất cả người dùng của nền tảng tại đây</h2>
      ...
      <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mr-6">
        <Card className="rounded-md shadow-md border border-gray-200 hover:shadow-lg transition-shadow p-3">
          <CardHeader className="flex flex-row items-center justify-between p-2 bg-gray-50 rounded-t-md">
            <CardTitle className="text-lg font-semibold text-gray-800">Tổng số học viên</CardTitle>
        ...
        <Card className="rounded-md shadow-md border border-gray-200 hover:shadow-lg transition-shadow p-3">
          <CardHeader className="flex flex-row items-center justify-between p-2 bg-gray-50 rounded-t-md">
            <CardTitle className="text-lg font-semibold text-gray-800">Tổng số giáo viên</CardTitle>
        ...
        <Card className="rounded-md shadow-md border border-gray-200 hover:shadow-lg transition-shadow p-3">
          <CardHeader className="flex flex-row items-center justify-between p-2 bg-gray-50 rounded-t-md">
            <CardTitle className="text-lg font-semibold text-gray-800">Tổng số giáo vụ</CardTitle>
      ...
      <div className="overflow-x-auto mt-6 max-h-[400px] mr-6">
        <table className="min-w-full table-auto border-collapse">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Họ tên</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Mã số</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Chức vụ</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Trạng thái</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Ngày tạo</th>
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Hành động</th>
            </tr>
          </thead>
          <tbody>
