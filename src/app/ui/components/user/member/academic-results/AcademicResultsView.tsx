        ...
        <CardContent>
          <div className="p-4 bg-primary-lighter rounded-lg border border-primary-light">
            <p className="text-gray-700 italic">
              "Học sinh có khả năng học tập tốt, đặc biệt trong các môn khoa học tự nhiên. 
              Cần cố gắng hơn trong môn Ngữ văn và tích cực tham gia các hoạt động nhóm. 
              Tinh thần học tập nghiêm túc, có tiềm năng phát triển tốt trong tương lai."
            </p>
