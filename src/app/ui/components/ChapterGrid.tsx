                        ...
                        >
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex flex-col justify-center h-full">
                                    <h2 className="text-xl font-semibold text-gray-800 mb-1">{chapter.name}</h2>
                            ...
                            <div className="absolute inset-0 bg-gray-300 bg-opacity-80 flex items-center justify-center rounded-xl opacity-0 hover:opacity-100 transition-opacity duration-300">
                                <Button
                                    ...
                                    onClick={() => window.location.href = handleAttachmentClick(courseId, subject, gradeId, grade, chapter.id.toString(), chapter.name)}
                                >
                                    Xem thư mục
                                </Button>
                            </div>
