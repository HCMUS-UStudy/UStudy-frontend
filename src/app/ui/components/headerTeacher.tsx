...
const HeaderTeacher: React.FC = () => {
    ...
    const handleProfileClick = () => {
        window.location.href = "/teacher/profile"; // Chuyển hướng tới trang profile
    };
        ...
        <div className={headerStyle}>
            <div className="hello">
                <div className="first-line">
                    Xin chào!! {<PiHandWavingThin className="icon" size={25} />}
                </div>
            ...
            <div className="right-items">
                ...
                <div className={`message ${hasNewMessage ? 'new' : ''}`}>
                    ...
                    {hasNewMessage && <span className="badge">3</span>} {/* Số lượng tin nhắn mới */}
                </div>
...
export default React.memo(HeaderTeacher);
