      ...
      className={cn(
        {
          ...
          "relative group bg-primary hover:bg-hover-primary hover:drop-shadow-sm transition-all duration-200 text-black text-sm md:text-[15px] disabled:bg-primary-dark":
            variant === "primary",
        ...
        "flex items-center justify-center font-medium px-2 py-2 md:px-3 md:py-2 rounded-lg disabled:cursor-auto",
        className,
      )}
      {...props}
    >
