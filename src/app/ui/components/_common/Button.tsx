      ...
      className={cn(
        {
          ...
          "relative group bg-primary hover:bg-hover-primary hover:drop-shadow-sm transition-all duration-200 text-black disabled:from-disabled-dark disabled:to-disabled-dark disabled:text-disabled-light":
            variant === "primary",
