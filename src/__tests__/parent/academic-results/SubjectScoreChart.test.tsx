...
import { SubjectScoreChart } from "@/app/ui/components/user/parent/academic-results/SubjectScoreChart";
import "@testing-library/jest-dom";

describe("SubjectScoreChart", () => {
  it("renders without crashing with data", () => {
    ...
    render(<SubjectScoreChart data={mockData} />);
